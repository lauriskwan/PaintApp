var canvasSettings = {
  ...
  changeText: function () {
    canvasSettings.textFont = $("#textFont").val();
    $("#textFont").css("font-family", $("#textFont").val());
    $(".showTextSize").css("font-family", $("#textFont").val());
  },
  //Tool Functions
  ...
  keyPress: function (e) {
    ...
    if (evtobj.keyCode == 51 && evtobj.altKey) {
      $(".bubblesButton").trigger("click");
    } //alt+3
    if (evtobj.keyCode == 52 && evtobj.altKey) {
      $(".wormButton").trigger("click");
    } //alt+4
    if (evtobj.keyCode == 53 && evtobj.altKey) {
      $(".textButton").trigger("click");
    } //alt+5
    if (evtobj.keyCode == 81 && evtobj.altKey) {
      $(".findColorButton").trigger("click");
    } //alt+q
    if (evtobj.keyCode == 87 && evtobj.altKey) {
      $(".lineButton").trigger("click");
    } //alt+w
    if (evtobj.keyCode == 69 && evtobj.altKey) {
      $(".quadraticCurveButton").trigger("click");
    } //alt+e
